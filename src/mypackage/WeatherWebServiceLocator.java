...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements mypackage.WeatherWebService {
 ...
 */
    ...
    public mypackage.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public mypackage.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.WeatherWebServiceSoap12Stub _stub = new mypackage.WeatherWebServiceSoap12Stub(portAddress, this);
    ...
    public mypackage.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public mypackage.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.WeatherWebServiceSoap_BindingStub _stub = new mypackage.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.WeatherWebServiceSoap12Stub _stub = new mypackage.WeatherWebServiceSoap12Stub(new java.net.URL(WeatherWebServiceSoap12_address), this);
                _stub.setPortName(getWeatherWebServiceSoap12WSDDServiceName());
                return _stub;
            }
            if (mypackage.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.WeatherWebServiceSoap_BindingStub _stub = new mypackage.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
